...
const I18N = {
  ru: {
    ...
    mode_schema: "🎭 Эмоции", mode_journey: "🧭 Погружение", mode_atlas: "🧠 Атлас",
    ...
    schema_title: "Карта эмоций → мозг",
    schema_sub: "Выберите чувство — на 3D-модели загорятся зоны, которые за него отвечают, а рядом появится короткое объяснение почему.",
    emo_pick: "Выберите эмоцию, чтобы увидеть её на модели мозга.",
    emo_lit: "подсвечены ответственные зоны",
  ...
  en: {
    ...
    mode_schema: "🎭 Emotions", mode_journey: "🧭 Deep dive", mode_atlas: "🧠 Atlas",
    ...
    schema_title: "Emotion map → brain",
    schema_sub: "Pick a feeling — the 3D model lights up the regions behind it, with a short why alongside.",
    emo_pick: "Pick an emotion to see it on the brain model.",
    emo_lit: "responsible regions highlighted",
